...
const dictionaries: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'sidebar.loadingMetadata': '正在加载元数据...',
    'sidebar.tools': '工具',
    'sidebar.relationshipQuery': '关系查询',
    'sidebar.patternConfig': '模式配置',
    'canvas.versions': '版本',
    'canvas.save': '保存',
    'canvas.zoomFit': '适配屏幕',
    'canvas.zoomOut': '缩小',
    ...
    'canvas.lineMode': '连线模式',
    'canvas.referenceMode': '引用模式',
    'canvas.context.group': '组合',
    'canvas.context.ungroup': '取消组合',
    'canvas.context.alignLeft': '左对齐',
    'canvas.context.alignCenterX': '水平居中',
    'canvas.context.alignTop': '顶对齐',
    'canvas.context.alignCenterY': '垂直居中',
    'canvas.context.nodeStyle': '节点样式（颜色）',
    'canvas.context.nodeStyleSelected': '设置选中节点样式（颜色）',
    ...
    'canvas.connectionMenu.delete': '删除连接',
    'canvas.connectionMenu.deleteConfirm': '确定删除该连接吗？关联画布将解除关联。',
    'canvas.headerColorDialog.title': '表头颜色',
    'canvas.headerColorDialog.description': '为选中的数据表表头选择一个颜色。',
    'canvas.headerColorDialog.field.color': '颜色',
    'common.close': '关闭',
    'common.copy': '复制',
    'common.download': '下载',
    ...
    'toast.connectionTimeout': '连接超时，已取消',
    'toast.error': '错误',
  ...
  en: {
    ...
    'sidebar.loadingMetadata': 'Loading metadata...',
    'sidebar.tools': 'Tools',
    'sidebar.relationshipQuery': 'Relationship Query',
    'sidebar.patternConfig': 'Pattern Config',
    ...
    'canvas.lineMode': 'Line Mode',
    'canvas.referenceMode': 'Reference Mode',
    'canvas.context.group': 'Group',
    'canvas.context.ungroup': 'Ungroup',
    'canvas.context.alignLeft': 'Align left',
    'canvas.context.alignCenterX': 'Align center (horizontal)',
    'canvas.context.alignTop': 'Align top',
    'canvas.context.alignCenterY': 'Align middle (vertical)',
    'canvas.context.nodeStyle': 'Node style (color)',
    'canvas.context.nodeStyleSelected': 'Node style (color) for selection',
    ...
    'canvas.connectionMenu.delete': 'Delete Connection',
    'canvas.connectionMenu.deleteConfirm': 'Delete this connection? Related canvases will be unlinked.',
    'canvas.headerColorDialog.title': 'Header color',
    'canvas.headerColorDialog.description': 'Choose a color for the selected table headers.',
    'canvas.headerColorDialog.field.color': 'Color',
    'common.close': 'Close',
    'common.copy': 'Copy',
    ...
    'toast.connectionTimeout': 'Connection timed out and was cancelled',
    'toast.error': 'Error',
